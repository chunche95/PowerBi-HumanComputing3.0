...
<p>
    ...
    Para evitar el uso de Diagramas de E/R, que es más 'para el informático'.
    <blockquote>
        <img src="Imágenes/E-R.PNG" alt="">
    </blockquote>
    Caer en la tentativa de Excels tipo Sábana
    <blockquote>
        <img src="Imágenes/TablasSabana.PNG" alt=""> 
    </blockquote>
